...
------------------------------------------- Blaine County
	...
	RetourCamion = {
			Pos   = {x = 917.99530029297, y = 62.024486541748, z = 79.76},
			Color = {r = 204, g = 0, b = 0},
			Size  = {x = 5.0, y = 5.0, z = 3.0},
			Type  = 1,
			Paye = 3500
	...
	AnnulerMission = {
			Pos   = {x = 908.22473144531, y = 45.296188354492, z = 79.76},
			Color = {r = 204, g = 0, b = 0},
			Size  = {x = 5.0, y = 5.0, z = 3.0},
			Type  = 1,
			Paye = 3500
