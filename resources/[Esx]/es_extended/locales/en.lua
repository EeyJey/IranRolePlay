Locales['en'] = {
  ...
  ['setfamily'] = 'assign a family to a user',
  ['setfamily_param2'] = 'the family you wish to assign',
  ['setfamily_param3'] = 'the family grade',
  ['create_family'] = 'Create a family with specefied name',
  ['family_name'] = 'The name of family',
  ['change_family'] = 'With this command you can Set/Update families options locations',
  ['data_change'] = 'Select option:(blip, armory, locker, boss, veh, vehdel, vehspawn, expire)',
  ['expire_time'] = 'Expire time like : 30 (its mean the family left in next 30 days!)',
  ['load_ipl'] = 'load IPL',
