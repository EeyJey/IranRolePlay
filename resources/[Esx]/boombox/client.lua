	...
	ESX.UI.Menu.Open(
		...
		function(data, menu) -- on cancel
			...
			if parent == nil then
				...
				local vehicle = GetVehiclePedIsIn(GetPlayerPed(-1), false)
				FreezeEntityPosition(vehicle, false)s
				myCar = {}
			end
		end,
...
Citizen.CreateThread(function()
	while IsmenuIsShowed do
		DisableControlAction(0, 75, true)
		DisableControlAction(0, "F1", true)
		DisableControlAction(0, "F2", true)
		DisableControlAction(0, "F3", true)
		DisableControlAction(0, "F5", true)
		DisableControlAction(0, "F6", true)
		DisableControlAction(0, "F7", true)
	else
