...
Config.ReviveReward               = 3500  -- revive reward, set to 0 if you don't want it enabled
...
Config.AuthorizedVehicles = {
	...
	ambulance = {
		...
		{ model = 'ambu1', label = 'Custom ambu2', price = 1000},
		{ model = 'ambulance4', label = 'ambulance Benz', price = 1000},
		{ model = 'qrv', label = 'Ford', price = 3000}
	},
...
Config.AuthorizedHelicopters = {
	...
	doctor = {
		...
		{ model = 'cgheli', label = 'Medic Heli', price = 20000 }
	},
