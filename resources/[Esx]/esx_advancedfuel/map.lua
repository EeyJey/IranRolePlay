...
station = {
    {x=457.916,y=-1013.447,z=27.317,s=1},
    ...
    {x=-804.304,y=163.297,z=71.537,s=26},
    {x=-809.283,y=161.606,z=71.546,s=26}
}
...
function isNearBoatStationMarker(items)
    ...
    if(GetDistanceBetweenCoords(items.x, items.y, items.z, plyCoords["x"], plyCoords["y"], plyCoords["z"], true) < 150) then
        return true, GetDistanceBetweenCoords(items.x, items.y, items.z, plyCoords["x"], plyCoords["y"], plyCoords["z"], true)
    end
