  ...
  function OpenCloakroomMenu()
	  ...
	  ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom',
	  {
		  ...
		  if
			  ...
			  data.current.value == 'po1_wear' or
			  data.current.value == 'po2_wear' or
			  data.current.value == 'po3_wear' or
...
function SendPoliceDistressSignal()
	...
	TriggerServerEvent('InteractSound_CL:PlayWithinDistance', 2.0, 'demo', 0.5)
