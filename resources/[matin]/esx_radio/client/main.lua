...
Citizen.CreateThread(function()
    while true do
        Citizen.Wait(1)
        if IsControlPressed(2, Keys["M"]) and GetLastInputMethod(2) and Busy == false then
        ...
        elseif not IsControlPressed(2, Keys["M"]) and GetLastInputMethod(2) and Busy == true then
...
AddEventHandler("onClientMapStart", function()
    NetworkSetTalkerProximity(16.00)		
end)
...
AddEventHandler("esx_walkie:stopActionB", function()
    NetworkSetTalkerProximity(16.00) -- Sprachreichweite wird 6 Meter
end)
