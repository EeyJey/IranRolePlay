...
TriggerEvent('es:addGroupCommand', 'pdata', Config.permission, function (source, args, user)
	local identifier
	local license
		...
		if target and target > 0 then
			...
			if ping and ping > 0 then
				if duree and duree < 365 then
					...
					if duree > 0 then
						ban(source,"pdata",identifier,license,liveid,xblid,discord,playerip,targetplayername,sourceplayername,duree,reason,permanent)
		...
		if target and target > 0 then
			...
			if ping and ping > 0 then
				if duree and duree < 365 then
					...
					if duree > 0 then
						ban(source,"banlist",identifier,license,liveid,xblid,discord,playerip,targetplayername,sourceplayername,duree,reason,permanent)
						DropPlayer(target, Text.yourban .. reason)
					else
						local permanent = 1
						ban(source,"banlist",identifier,license,liveid,xblid,discord,playerip,targetplayername,sourceplayername,duree,reason,permanent)
...
function ban(source,db,identifier,license,liveid,xblid,discord,playerip,targetplayername,sourceplayername,duree,reason,permanent)
