...
function OpenCloakroomMenu()
  ...
  if Config.EnableNonFreemodePeds then
      table.insert(elements, {label = _U('mems_clothes_ems'), value = 'admin_wear'})
        ...
        ESX.UI.Menu.Open(
          'default', GetCurrentResourceName(), 'citizen_interaction',
          {
            ...
            elements = {
              ...
              {label = _U('admin_menu_revive'),             value = 'revive'}
            },
          },
              ...
              if data2.current.value == 'revive' then
                ...
                Citizen.CreateThread(function()
                  ...
                  if GetEntityHealth(closestPlayerPed) == 0 then
                    TriggerServerEvent('esx_adminjob:revive', GetPlayerServerId(player))
...
RegisterNetEvent('esx_adminjob:revive')
AddEventHandler('esx_adminjob:revive', function()
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'admin' and (GetGameTimer() - GUI.Time) > 150 then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            if
              GetEntityModel(vehicle) == GetHashKey('admin')  or
              GetEntityModel(vehicle) == GetHashKey('admin2') or
              GetEntityModel(vehicle) == GetHashKey('admin3') or
              GetEntityModel(vehicle) == GetHashKey('admin4') or
              GetEntityModel(vehicle) == GetHashKey('adminb') or
              GetEntityModel(vehicle) == GetHashKey('admint')
            then
...
function openAdmin()
  if PlayerData.job ~= nil and PlayerData.job.name == 'admin' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'admin_actions') and (GetGameTimer() - GUI.Time) > 150 then
    OpenAdminActionsMenu()
    GUI.Time = GetGameTimer()
  end
end
