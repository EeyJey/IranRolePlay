...
local RegisteredFamilies = {
	...
	},
	{
		name      = 'Slasher',
		label     = 'family',
		account   = 'family_slasher',
		datastore = 'family_slasher',
		inventory = 'family_slasher',
		data      = 'family_slasher',
	},
	{
		name      = 'Vice_Lord',
		label     = 'family',
		account   = 'family_vice_lord',
		datastore = 'family_vice_lord',
		inventory = 'family_vice_lord',
		data      = 'family_vice_lord',
	},
}
