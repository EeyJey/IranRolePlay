...
{    
    ...
    */
    ...
    [
		...
		"قوانین سرور را در سایت gtav.modders.ir بخوانید",
		"برای باز کردن صندوق ماشین alt بزنید",
		"برای تغییر مقدار صداتون تو بازی H بزنید",
		"در صورت دیدن باگ میتونید در سایت gtav.modders.ir اطلاع دهید",
		"در صورتی که میخواید پلیری را ریپورت کنید در سایت gtav.modders.ir اطلاع دهید"
    ],
